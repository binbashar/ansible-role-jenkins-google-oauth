...
# Ansible Role: binbash_inc.ansible_role_jenkins_google_oauth
...
- [**pipeline-job**](https://app.circleci.com/pipelines/github/binbashar/ansible-role-jenkins-google-oauth) (**NOTE:** Will only run after merged PR)
- [**releases**](https://github.com/binbashar/ansible-role-jenkins-google-oauth/releases) 
- [**changelog**](https://github.com/binbashar/ansible-role-jenkins-google-oauth/blob/master/CHANGELOG.md) 
